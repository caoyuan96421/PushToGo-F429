...
#define MBED_CONF_PUSHTOGO_MAX_SPEED                      6.0                                                                                                   // set by library:pushtogo
#define MBED_CONF_PUSHTOGO_CURRENT_IDLE                   0.3                                                                                                   // set by library:pushtogo
#define MBED_CONF_PUSHTOGO_AXIS_BEHAVIORS                 The following settings control some details in the way that Go-To is implemented. Tweak as necessary. // set by library:pushtogo
...
#define MBED_CONF_PUSHTOGO_REDUCTION_FACTOR               180.0                                                                                                 // set by library:pushtogo
...
#define MBED_CONF_PUSHTOGO_MICROSTEP_TRACK                128                                                                                                   // set by library:pushtogo
#define MBED_CONF_PUSHTOGO_CORRECTION_TOLERANCE           0.05                                                                                                  // set by library:pushtogo
...
#define MBED_CONF_PUSHTOGO_MICROSTEP_SLEW                 32                                                                                                    // set by library:pushtogo
...
#define MBED_CONF_PUSHTOGO_CURRENT_CORRECTION             0.5                                                                                                   // set by library:pushtogo
...
#define MBED_CONF_PUSHTOGO_MICROSTEP_CORRECTION           128                                                                                                   // set by library:pushtogo
#define MBED_CONF_PPP_CELL_IFACE_AT_PARSER_TIMEOUT        8000                                                                                                  // set by library:ppp-cell-iface
#define MBED_CONF_PUSHTOGO_CURRENT_TRACK                  0.5                                                                                                   // set by library:pushtogo
...
#define MBED_CONF_PUSHTOGO_ACCELERATION_STEP_TIME         0.1                                                                                                   // set by library:pushtogo
